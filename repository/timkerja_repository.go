...
type TimKerjaRepository interface {
	...
	FindAllByBulanTahun(ctx context.Context, tx *sql.Tx, bulan int, tahun int) ([]domain.TimKerja, error)
	...
	FindRencanaKinerjaByIdAndKodeTim(ctx context.Context, tx *sql.Tx, id int, kodeTim string) (domain.RencanaKinerjaTimKerja, error)
}
