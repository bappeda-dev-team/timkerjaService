...
func InitializedServer() *echo.Echo {
	...
	timKerjaServiceImpl := service.NewTimKerjaServiceImpl(timKerjaRepositoryImpl, petugasTimServiceImpl, db, validate, eventClient)
	timKerjaControllerImpl := controller.NewTimKerjaControllerImpl(timKerjaServiceImpl)
	susunanTimServiceImpl := service.NewSusunanTimServiceImpl(susunanTimRepositoryImpl, timKerjaServiceImpl, db, validate, eventClient)
